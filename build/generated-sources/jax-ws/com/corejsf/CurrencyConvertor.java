 ...
 * 
 */
@WebServiceClient(name = "CurrencyConvertor", targetNamespace = "http://www.webserviceX.NET/", wsdlLocation = "file:/C:/mass/CurrencyConvertor.asmx")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/mass/CurrencyConvertor.asmx");
